...
SELECT DISTINCT department FROM course; --El asterisco selecciona todas las columnas
--CON DISTINCT AGARRAMOS SIN QUE SE REPITAN
...
SELECT
	gender AS "Gender",
	count(gender) AS "Count" --Para que el count funcione tiene que estar agrupado
FROM
	student
WHERE
	age>= 25
